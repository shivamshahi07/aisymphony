...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] p-8">
      <div className="text-center tracking-wide md:text-6xl text-3xl   justify-center mt-20 lg:px-44 font-bold leading-snug">
        <RevealAnimation direction="left" className="flex items-center justify-center">
          Generate AI-powered content with{" "}
        </RevealAnimation>
        <RevealAnimation direction="right" className="inline-block relative">

        <span
          id="stroke"
          className="relative whitespace-nowrap text-teal-500 ml-3 mb-8"
          >
          <svg
            aria-hidden="true"
            width="159"
          ...
          <span className="relative ">AI Symphony</span>
        </span>{" "}
            </RevealAnimation>
      </div>
      <RevealAnimation direction="bottom" className="md:text-2xl -mt-2 text-lg font-medium text-neutral-400 tracking-normal leading-snug  md:px-36">
