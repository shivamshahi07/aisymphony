// .wrangler/tmp/bundle-heEf8q/checked-fetch.js
...
app.post("/generate-image", async (c) => {
  try {
    ...
    console.error(
      `${(/* @__PURE__ */ new Date()).toISOString()} - POST /generate-image Error: `,
      error
    );
    return c.json(
...
app.post("/generate-summary", async (c) => {
  try {
    ...
    console.error(
      `${(/* @__PURE__ */ new Date()).toISOString()} - POST /generate-summary Error: `,
      error
    );
    return c.json(
...
// .wrangler/tmp/bundle-heEf8q/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-heEf8q/middleware-loader.entry.ts
